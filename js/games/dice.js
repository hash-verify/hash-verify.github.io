...
window.PFGames.verifyDice = function (ctx) {
  var el = ctx.el;
  var H = ctx.H;
  ...
  var randomR = parts.r;
  var diceNumber = Math.floor(randomR * 10001);
  var diceResult = (diceNumber / 100).toFixed(2);
  ...
  el.crashModules.innerHTML =
    ...
    '<div class="result-line"><span class="k">Scaled Value:</span><span>floor(R × 10001) = ' + diceNumber + "</span></div>" +
    '<div class="result-line"><span class="k">Final Result:</span><span>' + diceResult + "</span></div>" +
    "</div>";
